...
<head>
  <title>HOME :: <?= $configuration['app_name'] ?></title>
  <meta charset="UTF-8" />
...
<body>
  <!--Header-part-->
  <div id="header">
    <img style="padding-top: 23px; padding-left: 50px; cursor: none !important;" width="100" src="https://i.ibb.co/qY8kkp2/png.png">
  </div>
  <!--close-Header-part-->
  <!--top-Header-menu-->
    ...
    <ul class="nav">
      ...
      <li class="dropdown">
        ...
        <ul class="dropdown-menu">
          <li class=""><a title="Meu Perfil" href="<?= site_url('mapos/minhaConta'); ?>"><i class="fas fa-user"></i> <span class="text">Alterar Senha</span></a></li>
          <li class="divider"></li>
